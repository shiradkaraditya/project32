...
!function(t, e) {
    ...
    i = function() {
        ...
        if (i) {
            ...
            document.addEventListener("touchstart", o, !1)
        }
        return e
    }();
    var n;
    ...
    o = function() {
        ...
        t.prototype.disposeSound = function() {
            for (var t = 0; t < e.soundArray.length; t++)
                e.soundArray[t].dispose()
        }
        ,
        t.prototype.registerMethod("remove", t.prototype.disposeSound),
        t.prototype._checkFileFormats = function(i) {
            var n;
            if ("string" == typeof i) {
                n = i;
                var o = n.split(".").pop();
                if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(o) > -1)
                    if (t.prototype.isFileSupported(o))
                        n = n;
                    else
    ...
    a = function() {
        ...
        t.SoundFile.prototype.play = function(t, e, i, n, o) {
            ...
            var r, s, a = this, u = p.audiocontext.currentTime, c = t || 0;
            if (0 > c && (c = 0),
            c += u,
            ...
            "restart" === this.mode && this.buffer && this.bufferSourceNode && (this.bufferSourceNode.stop(c),
            this._counterNode.stop(c)),
            "untildone" !== this.mode || !this.isPlaying()) {
                ...
                this._paused ? (this.bufferSourceNode.start(c, this.pauseTime, o),
                this._counterNode.start(c, this.pauseTime, o)) : (this.bufferSourceNode.start(c, r, o),
        ...
        t.SoundFile.prototype._initCounterNode = function() {
            ...
            e._scopeNode.onaudioprocess = function(t) {
                ...
                e._lastPos = i[i.length - 1] || 0,
                e._onTimeUpdate(e._lastPos)
            }
            ,
            n
        }
    ...
    c = function() {
        ...
        t.FFT.prototype.analyze = function() {
            ...
            if (t && "db" === t.toLowerCase())
                ...
                this.freqDomain;
            o(this, this.freqDomain),
            this.analyser.getByteFrequencyData(this.freqDomain);
            var n = Array.apply([], this.freqDomain);
            return n.length === this.analyser.fftSize,
            n.constructor === Array,
            n
        }
        ,
    ...
    P = function() {
        ...
        e.prototype.scale = function(e, i, n, o) {
            ...
            a = t.prototype.map(o, e, i, 0, 1) - .5) : (s = arguments[0],
            a = arguments[1]);
            var u = new r(s,a);
    ...
    k = function() {
        ...
        t.Oscillator.prototype.scale = function(e, i, n, o) {
            ...
            u = t.prototype.map(o, e, i, 0, 1) - .5) : (a = arguments[0],
            u = arguments[1]);
            var c = new r(a,u)
    ...
    Y = function() {
        ...
        t.Filter.prototype.freq = function(t, e) {
            var i = e || 0;
            return 0 >= t && (t = 1),
            "number" == typeof t ? (this.biquad.frequency.value = t,
            this.biquad.frequency.cancelScheduledValues(this.ac.currentTime + .01 + i),
    ...
    J = function() {
        ...
        t.Convolver = function(t, e, n) {
            ...
            this.convolverNode.connect(this.wet),
            t ? (this.impulses = [],
            this._loadBuffer(t, e, n)) : (this._seconds = 3,
            this._decay = 2,
            this._reverse = !1,
            this._buildImpulse())
        }
            ...
            u.onload = function() {
                if (200 === u.status)
                    a.decodeAudioData(u.response, function(t) {
                        ...
                        e.audioBuffer = t,
                        r.impulses.push(e),
                        r.convolverNode.buffer = e.audioBuffer,
                        n && n(e)
                    }, function() {
    ...
    rt = function() {
        ...
        t.SoundRecorder = function() {
            this.input = r.createGain(),
            this.output = r.createGain(),
            this.recording = !1,
            this.bufferSize = 1024,
            this._channels = 2,
            this._clear(),
            this._jsNode = r.createScriptProcessor(this.bufferSize, this._channels, 2),
            this._jsNode.onaudioprocess = this._audioprocess.bind(this),
            this._callback = function() {}
            ,
            this._jsNode.connect(t.soundOut._silentNode),
            this.setInput(),
            o.soundArray.push(this)
        }
        ,
        ...
        t.SoundRecorder.prototype.record = function(t, e, i) {
            this.recording = !0,
            e && (this.sampleLimit = Math.round(e * r.sampleRate)),
        ...
        t.prototype.saveSound = function(n, o) {
            var r, s;
            r = n.buffer.getChannelData(0),
            s = n.buffer.numberOfChannels > 1 ? n.buffer.getChannelData(1) : r;
            var a = e(r, s)
              , u = new window.ArrayBuffer(44 + 2 * a.length)
              , c = new window.DataView(u);
            i(c, 0, "RIFF"),
            c.setUint32(4, 36 + 2 * a.length, !0),
            i(c, 8, "WAVE"),
            i(c, 12, "fmt "),
            c.setUint32(16, 16, !0),
            c.setUint16(20, 1, !0),
            c.setUint16(22, 2, !0),
            c.setUint32(24, 44100, !0),
            c.setUint32(28, 176400, !0),
            c.setUint16(32, 4, !0),
            c.setUint16(34, 16, !0),
            i(c, 36, "data"),
            c.setUint32(40, 2 * a.length, !0);
            for (var p = a.length, h = 44, l = 1, f = 0; p > f; f++)
                c.setInt16(h, a[f] * (32767 * l), !0),
                h += 2;
    ...
    ct = function() {
        ...
        t.MonoSynth = function() {
            ...
            this.filter = new t.Filter("highpass"),
            this.filter.set(5, 1),
            this.oscillator.disconnect(),
        ...
        t.MonoSynth.prototype.triggerAttack = function(t, e, i) {
            var i = ~~i
              ...
              , o = e || .1;
            this._isOn = !0,
            this.oscillator.freq(n, 0, i),
            this.env.ramp(this.output, i, o)
        }
        ,
        t.MonoSynth.prototype.triggerRelease = function(t) {
            var t = t || 0;
            this.env.ramp(this.output, t, 0),
            this._isOn = !1
        }
        ,
    ...
    pt = function() {
        ...
        t.PolySynth.prototype.noteAttack = function(n, o, s) {
            var a, s = ~~s, u = e.audiocontext.currentTime + s, c = r(n), p = o || .1;
        ...
        t.PolySynth.prototype.noteRelease = function(t, i) {
            ...
            if (t) {
                ...
                if (this.notes[a] && null !== this.notes[a].getValueAtTime(s)) {
                    ...
                    this.audiovoices[this.notes[a].getValueAtTime(s)].triggerRelease(o),
